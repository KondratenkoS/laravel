...
/* Подключите внутри хедера компонент с логотипом сайта. */
/* Подключите внутри хедера компонент с контактными данными. */
...
Route::get('/components', [\App\Http\Controllers\components\UserController::class, 'show']);
...
/* UPL GENERATION */
Route::get('/url_generation', [\App\Http\Controllers\url_generation\UserController::class, 'url_generation']);
